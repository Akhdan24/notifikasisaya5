...
class notifikasippobpaymentberhasil extends StatelessWidget {
  const notifikasippobpaymentberhasil({Key? key}) : super(key: key);
                    ...
                    Container(
                      child: Row(children: [
                        Icon(Icons.signal_cellular_alt_outlined,
                            size: 16, color: '6B6B6B'.toColor()),
                        SizedBox(width: 5),
                        Text("Pulsa - 081285967787",
                            style: GoogleFonts.poppins().copyWith(
                                fontWeight: FontWeight.w300,
                                fontSize: 9,
                                color: '6B6B6B'.toColor())),
